    ...
    enabledVerifiers = defaultVerifiers, network = {
      ...
      ></iframe>`);
            ...
            const handleSetup = () => __awaiter(this, void 0, void 0, function* () {
                yield runOnLoad(attachIFrame);
                yield runOnLoad(this._setupWeb3.bind(this));
                ...
                yield runOnLoad(() => __awaiter(this, void 0, void 0, function* () {
                    initStream.write({
                        name: "init_stream",
                        data: {
                            enabledVerifiers,
                    ...
                    yield this._setProvider(network);
                    yield initCompletePromise;
