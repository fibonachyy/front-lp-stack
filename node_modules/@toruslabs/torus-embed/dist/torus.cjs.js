...
var torus_js_ = __webpack_require__(16);
...
var obs_store_ = __webpack_require__(17);
...
var _excluded = ["host", "chainId", "networkName"],
    _excluded2 = ["host", "chainId", "networkName"];
...
var iframeIntegrity = "sha384-Mu4tHmzs73qCjINmlcGDnLJGLzLJTcMsHmixSkQX3upWN7tcRILXuE05vWTtXAHA";
...
var embed_Torus = /*#__PURE__*/function () {
  ...
  createClass_default()(Torus, [{
            ...
            switch (_context4.prev = _context4.next) {
              ...
              case 5:
                ...
                attachIFrame = function attachIFrame() {
                  ...
                  _this.torusIframe.onload = function () {
                    // only do this if iframe is not full screen
                    if (!_this.isIframeFullScreen) _this._displayIframe();
                  };
                };

                handleSetup = /*#__PURE__*/function () {
                  var _ref4 = asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee3() {
                    var initStream, initCompletePromise;
                    return regenerator_default.a.wrap(function _callee3$(_context3) {
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          case 0:
                            _context3.next = 2;
                            return runOnLoad(attachIFrame);

                          case 2:
                            _context3.next = 4;
                            return runOnLoad(_this._setupWeb3.bind(_this));

                          case 4:
                            initStream = _this.communicationMux.getStream("init_stream");
                            initCompletePromise = new Promise(function (resolve, reject) {
                            ...
                            _context3.next = 8;
                            return runOnLoad( /*#__PURE__*/asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee2() {
                              return regenerator_default.a.wrap(function _callee2$(_context2) {
                                while (1) {
                                  switch (_context2.prev = _context2.next) {
                                    case 0:
                                      ...
                                      _context2.next = 3;
                                      return _this._setProvider(network);
    ...
    value: function _setProvider() {
      ...
      var _ref9$host = _ref9.host,
          host = _ref9$host === void 0 ? "mainnet" : _ref9$host,
          _ref9$chainId = _ref9.chainId,
          chainId = _ref9$chainId === void 0 ? null : _ref9$chainId,
          _ref9$networkName = _ref9.networkName,
          networkName = _ref9$networkName === void 0 ? "" : _ref9$networkName,
          rest = objectWithoutProperties_default()(_ref9, _excluded2);

      return new Promise(function (resolve, reject) {
        if (!_this7.isInitialized) {
          var providerChangeStream = _this7.communicationMux.getStream("provider_change");
    ...
    value: function _handleWindow(preopenInstanceId) {
      ...
      if (preopenInstanceId) {
        ...
        var closeHandler = function closeHandler(_ref11) {
          var receivedId = _ref11.preopenInstanceId,
              close = _ref11.close;
    ...
    value: function _setupWeb3() {
            ...
            if (err) {
              ...
              var handleLoginCb = function handleLoginCb() {
                if (_this8.requestedVerifier !== "" && _this8.currentVerifier !== _this8.requestedVerifier) {
                  var requestedVerifier = _this8.requestedVerifier; // eslint-disable-next-line promise/no-promise-in-callback

                  _this8.logout() // eslint-disable-next-line promise/always-return
                  .then(function (_) {
              ...
              if (_this8.isLoggedIn) {
                ...
                _this8.isLoginCallback = handleLoginCb;
              }
            } else {
      ...
      inpageProvider.tryPreopenHandle = function (payload, cb) {
        ...
        if (!Array.isArray(_payload) && UNSAFE_METHODS.includes(_payload.method)) {
          ...
          _this8._handleWindow(preopenInstanceId, {
            target: "_blank",
      ...
      windowStream.on("data", function (chunk) {
        if (chunk.name === "create_window") {
          ...
          _this8._createPopupBlockAlert(chunk.data.preopenInstanceId, chunk.data.url);
        }
      ...
      statusStream.on("data", function (status) {
        // login
        if (status.loggedIn) {
          _this8.isLoggedIn = status.loggedIn;
          _this8.currentVerifier = status.verifier;
        } // logout
        else _this8._displayIframe();

        if (_this8.isLoginCallback) {
          _this8.isLoginCallback();

          delete _this8.isLoginCallback;
        }
      });
    ...
    value: function _showLoginPopup(calledFromEmbed, resolve, reject) {
      ...
      var loginHandler = function loginHandler(data) {
        ...
        if (_this9.isIframeFullScreen) _this9._displayIframe();
      };
    ...
    value: function _createPopupBlockAlert(preopenInstanceId, url) {
      ...
      var bindOnLoad = function bindOnLoad() {
        successAlert.addEventListener("click", function () {
          ...
          torusAlert.remove();
          if (_this10.torusAlertContainer.children.length === 0) _this10.torusAlertContainer.style.display = "none";
        });
      };
      ...
      var attachOnLoad = function attachOnLoad() {
        _this10.torusAlertContainer.style.display = "block";

        _this10.torusAlertContainer.appendChild(torusAlert);
      };
